...
const ThirdSection = () => {
  return (
    <div className="bg-[url('/images/thirdBg.png')] xl:h-[1040px] lg:h-[800px] md:h-[700px] w-[100%] bg-no-repeat bg-cover  md:top-[-534px] xl:top-[-413px] lg:top-[-300] relative">
      ...
      <div className="absolute top-[17%] w-[100%] max-w-[500px]">
        <Button
          heading={"¿QUIÉNES"}
          subheading={"CON REPRESENTACIÓN"}
          description={"SOMOS?"}
        />
      </div>
      <div className="absolute w-full xl:top-[795px] md:top-[32rem] sm:top-[27rem]">
        <Services />
      </div>
    </div>
  );
